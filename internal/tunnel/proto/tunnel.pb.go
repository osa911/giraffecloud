...
// In the multi-tunnel model, the server derives all routing config from the token.
...
const file_tunnel_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\v \x01(\x03R\ttimestampB\x0e\n" +
	"\fmessage_type\"U\n" +
	"\x10ControlHandshake\x12%\n" +
	"\x0eclient_version\x18\x02 \x01(\tR\rclientVersion\x12\x14\n" +
	"\x05token\x18\x03 \x01(\tR\x05tokenJ\x04\b\x01\x10\x02\"\x9a\x01\n" +
	"\x0fTunnelHandshake\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12%\n" +
	"\x0eclient_version\x18\x04 \x01(\tR\rclientVersion\x12>\n" +
	"\fcapabilities\x18\x05 \x01(\v2\x1a.tunnel.TunnelCapabilitiesR\fcapabilitiesJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"\xdc\x01\n" +
