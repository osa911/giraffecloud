...
// ConfigUpdateReason describes why a config update was sent
type ConfigUpdateReason int32

const (
	ConfigUpdateReason_CONFIG_UPDATE_REASON_UNSPECIFIED    ConfigUpdateReason = 0
	ConfigUpdateReason_CONFIG_UPDATE_REASON_TUNNEL_CREATED ConfigUpdateReason = 1
	ConfigUpdateReason_CONFIG_UPDATE_REASON_TUNNEL_UPDATED ConfigUpdateReason = 2
	ConfigUpdateReason_CONFIG_UPDATE_REASON_TUNNEL_DELETED ConfigUpdateReason = 3
)

// Enum value maps for ConfigUpdateReason.
var (
	ConfigUpdateReason_name = map[int32]string{
		0: "CONFIG_UPDATE_REASON_UNSPECIFIED",
		1: "CONFIG_UPDATE_REASON_TUNNEL_CREATED",
		2: "CONFIG_UPDATE_REASON_TUNNEL_UPDATED",
		3: "CONFIG_UPDATE_REASON_TUNNEL_DELETED",
	}
	ConfigUpdateReason_value = map[string]int32{
...
func (x ConfigUpdateReason) Enum() *ConfigUpdateReason {
	p := new(ConfigUpdateReason)
	*p = x
	return p
}

func (x ConfigUpdateReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ConfigUpdateReason) Descriptor() protoreflect.EnumDescriptor {
	return file_tunnel_proto_enumTypes[1].Descriptor()
}

func (ConfigUpdateReason) Type() protoreflect.EnumType {
	return &file_tunnel_proto_enumTypes[1]
}

func (x ConfigUpdateReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ConfigUpdateReason.Descriptor instead.
func (ConfigUpdateReason) EnumDescriptor() ([]byte, []int) {
...
func (ErrorMessage_ErrorType) Descriptor() protoreflect.EnumDescriptor {
	return file_tunnel_proto_enumTypes[7].Descriptor()
}

func (ErrorMessage_ErrorType) Type() protoreflect.EnumType {
	return &file_tunnel_proto_enumTypes[7]
}
...
type ControlHandshake struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// domain is deprecated in the multi-tunnel model; use token for identity
...
func (x *ControlHandshake) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
// NOTE: In the multi-tunnel model, the server derives all routing config from
// the token. The domain and target_port fields are deprecated and ignored by
// the server; they are preserved here only for wire compatibility.
type TunnelHandshake struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Token string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	// deprecated: ignored by server in multi-tunnel model; routing is derived from token
...
func (x *TunnelControl) GetCancelRequest() *CancelRequest {
	if x != nil {
		if x, ok := x.ControlType.(*TunnelControl_CancelRequest); ok {
...
type TunnelControl_CancelRequest struct {
	CancelRequest *CancelRequest `protobuf:"bytes,6,opt,name=cancel_request,json=cancelRequest,proto3,oneof"` // NEW: Request cancellation
}
...
func (*TunnelControl_CancelRequest) isTunnelControl_ControlType() {}

// CancelRequest signals the client to stop processing a specific request
type CancelRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RequestId     string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // Request ID to cancel
	Reason        string                 `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"`                        // Why: "downstream_disconnected", "timeout", etc.
	Timestamp     int64                  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                 // When cancellation was triggered
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CancelRequest) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
// TunnelRouteConfig represents a single tunnel's routing configuration
...
func (x *TunnelRouteConfig) Reset() {
	*x = TunnelRouteConfig{}
...
func (x *TunnelRouteConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TunnelRouteConfig) ProtoMessage() {}

func (x *TunnelRouteConfig) ProtoReflect() protoreflect.Message {
	mi := &file_tunnel_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TunnelRouteConfig.ProtoReflect.Descriptor instead.
func (*TunnelRouteConfig) Descriptor() ([]byte, []int) {
	return file_tunnel_proto_rawDescGZIP(), []int{17}
}

func (x *TunnelRouteConfig) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
func (x *TunnelRouteConfig) GetTargetHost() string {
	if x != nil {
		return x.TargetHost
	}
	return ""
...
func (x *TunnelRouteConfig) GetTargetPort() int32 {
	if x != nil {
		return x.TargetPort
	}
	return 0
...
func (x *TunnelRouteConfig) GetIsEnabled() bool {
	if x != nil {
		return x.IsEnabled
	}
	return false
...
// ConfigUpdate carries the full updated route table to the CLI
type ConfigUpdate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Routes        []*TunnelRouteConfig   `protobuf:"bytes,1,rep,name=routes,proto3" json:"routes,omitempty"`
	Reason        ConfigUpdateReason     `protobuf:"varint,2,opt,name=reason,proto3,enum=tunnel.ConfigUpdateReason" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConfigUpdate) GetRoutes() []*TunnelRouteConfig {
	if x != nil {
		return x.Routes
	}
	return nil
...
func (x *ConfigUpdate) GetReason() ConfigUpdateReason {
	if x != nil {
		return x.Reason
	}
	return ConfigUpdateReason_CONFIG_UPDATE_REASON_UNSPECIFIED
}
...
type TunnelStatus struct {
	...
	Routes            []*TunnelRouteConfig   `protobuf:"bytes,10,rep,name=routes,proto3" json:"routes,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *TunnelStatus) GetRoutes() []*TunnelRouteConfig {
	if x != nil {
		return x.Routes
	}
	return nil
...
const file_tunnel_proto_rawDesc = "" +
	...
	"\x04pong\x18\x06 \x01(\v2\x13.tunnel.ControlPongH\x00R\x04pong\x12;\n" +
	"\rconfig_update\x18\a \x01(\v2\x14.tunnel.ConfigUpdateH\x00R\fconfigUpdate\x12\x1d\n" +
	"\n" +
	"request_id\x18\n" +
	" \x01(\tR\trequestId\x12\x1c\n" +
	"\ttimestamp\x18\v \x01(\x03R\ttimestampB\x0e\n" +
	...
	"\x0eclient_version\x18\x02 \x01(\tR\rclientVersion\x12\x14\n" +
	...
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\"\xb2\x03\n" +
	"\rTunnelControl\x127\n" +
	...
	"\x11establish_request\x18\x05 \x01(\v2\x1e.tunnel.TunnelEstablishRequestH\x00R\x10establishRequest\x12>\n" +
	"\x0ecancel_request\x18\x06 \x01(\v2\x15.tunnel.CancelRequestH\x00R\rcancelRequest\x12\x18\n" +
	"\amessage\x18\n" +
	...
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp\"\xdc\x01\n" +
	...
	"\x0fSTREAMING_ERROR\x10\a\"\x8c\x01\n" +
	"\x11TunnelRouteConfig\x12\x16\n" +
	...
	"targetPort\x12\x1d\n" +
	"\n" +
	"is_enabled\x18\x04 \x01(\bR\tisEnabled\"u\n" +
	"\fConfigUpdate\x121\n" +
	"\x06routes\x18\x01 \x03(\v2\x19.tunnel.TunnelRouteConfigR\x06routes\x122\n" +
	"\x06reason\x18\x02 \x01(\x0e2\x1a.tunnel.ConfigUpdateReasonR\x06reason\"\xc1\x02\n" +
	"\fTunnelStatus\x12)\n" +
	...
	"\x06routes\x18\n" +
	" \x03(\v2\x19.tunnel.TunnelRouteConfigR\x06routes\"\xe6\x02\n" +
	"\rTunnelMetrics\x12%\n" +
	...
	"\x12TUNNEL_TYPE_HYBRID\x10\x03*\xb5\x01\n" +
	"\x12ConfigUpdateReason\x12$\n" +
	" CONFIG_UPDATE_REASON_UNSPECIFIED\x10\x00\x12'\n" +
	"#CONFIG_UPDATE_REASON_TUNNEL_CREATED\x10\x01\x12'\n" +
	"#CONFIG_UPDATE_REASON_TUNNEL_UPDATED\x10\x02\x12'\n" +
	"#CONFIG_UPDATE_REASON_TUNNEL_DELETED\x10\x03*\xf1\x01\n" +
...
var file_tunnel_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_tunnel_proto_goTypes = []any{
	...
	(ConfigUpdateReason)(0),        // 1: tunnel.ConfigUpdateReason
	(TunnelState)(0),               // 2: tunnel.TunnelState
	(HealthStatus)(0),              // 3: tunnel.HealthStatus
	(RequestType)(0),               // 4: tunnel.RequestType
	(Priority)(0),                  // 5: tunnel.Priority
	(CacheStatus)(0),               // 6: tunnel.CacheStatus
	(ErrorMessage_ErrorType)(0),    // 7: tunnel.ErrorMessage.ErrorType
	(*TunnelMessage)(nil),          // 8: tunnel.TunnelMessage
	(*ControlMessage)(nil),         // 9: tunnel.ControlMessage
	(*ControlHandshake)(nil),       // 10: tunnel.ControlHandshake
	(*TunnelHandshake)(nil),        // 11: tunnel.TunnelHandshake
	(*TunnelCapabilities)(nil),     // 12: tunnel.TunnelCapabilities
	(*HTTPRequest)(nil),            // 13: tunnel.HTTPRequest
	(*HTTPResponse)(nil),           // 14: tunnel.HTTPResponse
	(*LargeFileRequest)(nil),       // 15: tunnel.LargeFileRequest
	(*LargeFileChunk)(nil),         // 16: tunnel.LargeFileChunk
	(*HTTPRequestStart)(nil),       // 17: tunnel.HTTPRequestStart
	(*HTTPRequestChunk)(nil),       // 18: tunnel.HTTPRequestChunk
	(*HTTPRequestEnd)(nil),         // 19: tunnel.HTTPRequestEnd
	(*TunnelControl)(nil),          // 20: tunnel.TunnelControl
	(*CancelRequest)(nil),          // 21: tunnel.CancelRequest
	(*TunnelEstablishRequest)(nil), // 22: tunnel.TunnelEstablishRequest
	(*TunnelConfig)(nil),           // 23: tunnel.TunnelConfig
	(*ErrorMessage)(nil),           // 24: tunnel.ErrorMessage
	(*TunnelRouteConfig)(nil),      // 25: tunnel.TunnelRouteConfig
	(*ConfigUpdate)(nil),           // 26: tunnel.ConfigUpdate
	(*TunnelStatus)(nil),           // 27: tunnel.TunnelStatus
	(*TunnelMetrics)(nil),          // 28: tunnel.TunnelMetrics
	(*ControlPing)(nil),            // 29: tunnel.ControlPing
	(*ControlPong)(nil),            // 30: tunnel.ControlPong
	(*HealthCheckRequest)(nil),     // 31: tunnel.HealthCheckRequest
	(*HealthCheckResponse)(nil),    // 32: tunnel.HealthCheckResponse
	(*RequestMetadata)(nil),        // 33: tunnel.RequestMetadata
	(*ResponseMetadata)(nil),       // 34: tunnel.ResponseMetadata
	nil,                            // 35: tunnel.HTTPRequest.HeadersEntry
	nil,                            // 36: tunnel.HTTPResponse.HeadersEntry
	nil,                            // 37: tunnel.LargeFileChunk.HeadersEntry
	nil,                            // 38: tunnel.HTTPRequestStart.HeadersEntry
	nil,                            // 39: tunnel.HealthCheckResponse.DetailsEntry
}
var file_tunnel_proto_depIdxs = []int32{
	11, // 0: tunnel.TunnelMessage.handshake:type_name -> tunnel.TunnelHandshake
	13, // 1: tunnel.TunnelMessage.http_request:type_name -> tunnel.HTTPRequest
	14, // 2: tunnel.TunnelMessage.http_response:type_name -> tunnel.HTTPResponse
	20, // 3: tunnel.TunnelMessage.control:type_name -> tunnel.TunnelControl
	24, // 4: tunnel.TunnelMessage.error:type_name -> tunnel.ErrorMessage
	27, // 5: tunnel.TunnelMessage.status:type_name -> tunnel.TunnelStatus
	17, // 6: tunnel.TunnelMessage.http_request_start:type_name -> tunnel.HTTPRequestStart
	18, // 7: tunnel.TunnelMessage.http_request_chunk:type_name -> tunnel.HTTPRequestChunk
	19, // 8: tunnel.TunnelMessage.http_request_end:type_name -> tunnel.HTTPRequestEnd
	10, // 9: tunnel.ControlMessage.handshake:type_name -> tunnel.ControlHandshake
	21, // 10: tunnel.ControlMessage.cancel:type_name -> tunnel.CancelRequest
	31, // 11: tunnel.ControlMessage.health_check:type_name -> tunnel.HealthCheckRequest
	32, // 12: tunnel.ControlMessage.health_response:type_name -> tunnel.HealthCheckResponse
	29, // 13: tunnel.ControlMessage.ping:type_name -> tunnel.ControlPing
	30, // 14: tunnel.ControlMessage.pong:type_name -> tunnel.ControlPong
	26, // 15: tunnel.ControlMessage.config_update:type_name -> tunnel.ConfigUpdate
	12, // 16: tunnel.TunnelHandshake.capabilities:type_name -> tunnel.TunnelCapabilities
	35, // 17: tunnel.HTTPRequest.headers:type_name -> tunnel.HTTPRequest.HeadersEntry
	33, // 18: tunnel.HTTPRequest.metadata:type_name -> tunnel.RequestMetadata
	36, // 19: tunnel.HTTPResponse.headers:type_name -> tunnel.HTTPResponse.HeadersEntry
	34, // 20: tunnel.HTTPResponse.metadata:type_name -> tunnel.ResponseMetadata
	13, // 21: tunnel.LargeFileRequest.http_request:type_name -> tunnel.HTTPRequest
	37, // 22: tunnel.LargeFileChunk.headers:type_name -> tunnel.LargeFileChunk.HeadersEntry
	38, // 23: tunnel.HTTPRequestStart.headers:type_name -> tunnel.HTTPRequestStart.HeadersEntry
	11, // 24: tunnel.TunnelControl.handshake:type_name -> tunnel.TunnelHandshake
	27, // 25: tunnel.TunnelControl.status:type_name -> tunnel.TunnelStatus
	23, // 26: tunnel.TunnelControl.config:type_name -> tunnel.TunnelConfig
	28, // 27: tunnel.TunnelControl.metrics:type_name -> tunnel.TunnelMetrics
	22, // 28: tunnel.TunnelControl.establish_request:type_name -> tunnel.TunnelEstablishRequest
	21, // 29: tunnel.TunnelControl.cancel_request:type_name -> tunnel.CancelRequest
	0,  // 30: tunnel.TunnelEstablishRequest.tunnel_type:type_name -> tunnel.TunnelType
	7,  // 31: tunnel.ErrorMessage.type:type_name -> tunnel.ErrorMessage.ErrorType
	25, // 32: tunnel.ConfigUpdate.routes:type_name -> tunnel.TunnelRouteConfig
	1,  // 33: tunnel.ConfigUpdate.reason:type_name -> tunnel.ConfigUpdateReason
	2,  // 34: tunnel.TunnelStatus.state:type_name -> tunnel.TunnelState
	25, // 35: tunnel.TunnelStatus.routes:type_name -> tunnel.TunnelRouteConfig
	3,  // 36: tunnel.HealthCheckResponse.status:type_name -> tunnel.HealthStatus
	28, // 37: tunnel.HealthCheckResponse.metrics:type_name -> tunnel.TunnelMetrics
	39, // 38: tunnel.HealthCheckResponse.details:type_name -> tunnel.HealthCheckResponse.DetailsEntry
	4,  // 39: tunnel.RequestMetadata.type:type_name -> tunnel.RequestType
	5,  // 40: tunnel.RequestMetadata.priority:type_name -> tunnel.Priority
	6,  // 41: tunnel.ResponseMetadata.cache_status:type_name -> tunnel.CacheStatus
	8,  // 42: tunnel.TunnelService.EstablishTunnel:input_type -> tunnel.TunnelMessage
	9,  // 43: tunnel.TunnelService.ControlChannel:input_type -> tunnel.ControlMessage
	15, // 44: tunnel.TunnelService.StreamLargeFile:input_type -> tunnel.LargeFileRequest
	31, // 45: tunnel.TunnelService.HealthCheck:input_type -> tunnel.HealthCheckRequest
	8,  // 46: tunnel.TunnelService.EstablishTunnel:output_type -> tunnel.TunnelMessage
	9,  // 47: tunnel.TunnelService.ControlChannel:output_type -> tunnel.ControlMessage
	16, // 48: tunnel.TunnelService.StreamLargeFile:output_type -> tunnel.LargeFileChunk
	32, // 49: tunnel.TunnelService.HealthCheck:output_type -> tunnel.HealthCheckResponse
...
func file_tunnel_proto_init() {
	...
	file_tunnel_proto_msgTypes[12].OneofWrappers = []any{
		...
		(*TunnelControl_CancelRequest)(nil),
	}
	type x struct{}
