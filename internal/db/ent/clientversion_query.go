...
func (cvq *ClientVersionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (cvq *ClientVersionQuery) FirstIDX(ctx context.Context) string {
...
func (cvq *ClientVersionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (cvq *ClientVersionQuery) OnlyIDX(ctx context.Context) string {
...
func (cvq *ClientVersionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (cvq *ClientVersionQuery) IDsX(ctx context.Context) []string {
	ids, err := cvq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.ClientVersion.Query().
//		Select(clientversion.FieldChannel).
//		Scan(ctx, &v)
...
func (cvq *ClientVersionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(clientversion.Table, clientversion.Columns, sqlgraph.NewFieldSpec(clientversion.FieldID, field.TypeString))
	_spec.From = cvq.sql
