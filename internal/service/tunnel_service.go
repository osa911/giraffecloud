...
// Returns error if user already has an auto-generated tunnel
func (s *tunnelService) GetFreeSubdomain(ctx context.Context, userID uint32) (string, error) {
	...
	for _, tunnel := range tunnels {
		if utils.IsAutoGeneratedDomain(tunnel.Domain) {
			return "", fmt.Errorf("user already has an auto-generated subdomain: %s", tunnel.Domain)
		}
	}
